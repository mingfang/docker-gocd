...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="updated">
    <xsl:if test="java:com.thoughtworks.studios.shine.cruise.CruiseDateTime.parseToZuluStringSwallowException(.) != ''">
      <cruise:stageUpdated rdf:datatype="http://www.w3.org/2001/XMLSchema#dateTime">
        <xsl:value-of select="java:com.thoughtworks.studios.shine.cruise.CruiseDateTime.parseToZuluStringSwallowException(.)"/>
      </cruise:stageUpdated>
    </xsl:if>
  </xsl:template>
