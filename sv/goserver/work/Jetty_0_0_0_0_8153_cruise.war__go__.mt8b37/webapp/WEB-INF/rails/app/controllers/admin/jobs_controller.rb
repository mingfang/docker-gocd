module Admin
  class JobsController < AdminController
    ...
    def new
      ...
      assert_load :job, JobConfig.new(CaseInsensitiveString.new(""), Resources.new, ArtifactPlans.new, com.thoughtworks.cruise.config.Tasks.new([AntTask.new].to_java(Task)))
    end
