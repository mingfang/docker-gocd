class Admin::PipelineGroupsController < AdminController
  ...
  def possible_groups
    load_groups
    match = cruise_config_service.doesMd5Match(params[:config_md5])
  ...
  def load_groups_for_edit
    ...
    group_for_edit = cruise_config_service.loadGroupForEditing(params[:group_name], current_user, result)
