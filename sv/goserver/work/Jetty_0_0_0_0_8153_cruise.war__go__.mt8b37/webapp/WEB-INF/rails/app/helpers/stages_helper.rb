module StagesHelper
  ...
  def placeholder_stage? stage
    stage.getState() == com.thoughtworks.cruise.domain.StageState::Unknown
  end
  ...
  def empty_stage(stage_instance_model)
    stage_instance_model.instance_of? com.thoughtworks.cruise.presentation.pipelinehistory.NullStageHistoryItem
  end
